...
const WordbookList = () => {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            let initialWordbooks = [];

            if (savedWordbooks) {
                initialWordbooks = JSON.parse(savedWordbooks);
            } else {
                // Default Mock Data
                initialWordbooks = [
                ...
                // Save default data to localStorage so we can add to it later
                localStorage.setItem('wordbooks', JSON.stringify(initialWordbooks));
            }

            setWordbooks(initialWordbooks);
            setLoading(false);
        }, 500);
    }, []);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Link to="/academy-admin/wordbooks/new" className="h-full min-h-[200px] border-4 border-black border-dashed flex flex-col items-center justify-center text-slate-400 hover:text-black hover:bg-slate-50 hover:border-solid transition-all group">
